...
| **agent/deploy/agent-framework-deploy** | Deploying AI agents and workflows built with Microsoft Agent Framework SDK to Microsoft Foundry. Use when user asks to deploy, publish, host, or go to production with agents. | [agent/deploy/agent-framework-deploy/SKILL.md](agent/deploy/agent-framework-deploy/SKILL.md) |
